    ...
    <div className="min-h-screen bg-white text-black flex flex-col">
      <header className="px-6 pt-8 flex items-center justify-between">
        <div className="flex items-center gap-2" data-testid="brand-logo">
          ...
          <span className="font-display font-black text-xl tracking-tighter">VECTOR</span>
        </div>
        <Link
          to="/login"
      ...
      <main className="flex-1 px-6 flex flex-col justify-center max-w-3xl mx-auto w-full py-16">
        <span className="label-eyebrow text-[#52525B] mb-6 animate-slide-up">A new ride. A new system.</span>
        <h1
        ...
        >
          Move<br />
          <span className="text-[#002FA7]">precisely.</span>
        </h1>
        <p
          className="text-lg sm:text-xl text-[#52525B] max-w-xl mb-12 leading-relaxed animate-slide-up"
          style={{ animationDelay: "0.1s" }}
        >
          A no-nonsense taxi network. Book a ride, drive your hours, get paid. No clutter, no fluff — just transit.
        </p>
      ...
      <footer className="border-t border-[#E4E4E7] px-6 py-6 grid grid-cols-3 gap-6 text-sm">
        <div>
          ...
          <div className="font-display font-bold text-2xl tracking-tighter">120+ cities</div>
        </div>
        <div>
          <div className="label-eyebrow text-[#52525B] mb-2">Avg pickup</div>
          <div className="font-display font-bold text-2xl tracking-tighter">3.2 min</div>
        </div>
        <div>
