    ...
    <div className="min-h-screen bg-white text-black px-6 py-10 max-w-md mx-auto">
      ...
      <div className="grid grid-cols-2 gap-3 mb-8">
        ...
        >
          ...
          <div className="text-xs mt-1 opacity-80">Book rides anywhere</div>
        </button>
        <button
        ...
        >
          ...
          <div className="text-xs mt-1 opacity-80">Earn on your schedule</div>
        </button>
      </div>

      <label className="label-eyebrow text-[#52525B] mb-2 block">Full name</label>
      <input
        data-testid="onboarding-name-input"
        value={name}
        onChange={(e) => setName(e.target.value)}
        placeholder="Alex Morgan"
        className="w-full px-4 py-4 text-lg font-medium border-2 border-black bg-white focus:outline-none focus:border-[#002FA7] mb-6"
      />

      {role === "driver" && (
        <div className="space-y-4 mb-4 border-t-2 border-black pt-6">
