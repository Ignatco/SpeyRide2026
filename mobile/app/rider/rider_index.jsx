...
export default function RiderHome() {
  ...
  // Real road route for map preview
  const [tripRoute, setTripRoute] = useState(null);   // [[lng,lat],...]
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Route loading / info badge */}
      {(routeLoading || (tripRoute && estimates)) && (
        <SafeAreaView edges={['top']} style={styles.routeBadgeWrap} pointerEvents="none">
          <View style={[styles.routeBadge, routeLoading && styles.routeBadgeLoading]}>
            {routeLoading ? (
              <>
                <ActivityIndicator size="small" color={colors.riderTextMuted} />
                <Text style={styles.routeBadgeText}>Calculating route…</Text>
              </>
            ) : (
              <>
                <Ionicons name="navigate" size={13} color={colors.white} />
                <Text style={[styles.routeBadgeText, { color: colors.white }]}>
                ...
                {VEHICLES.map((v) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <Text style={[styles.vehicleEta, active && { color: colors.white, opacity: 0.85 }]}>
                        {v.eta}
                      </Text>
...
const styles = StyleSheet.create({
  ...
  routeBadgeWrap: { position: 'absolute', top: 0, left: 0, right: 0, zIndex: 25, alignItems: 'center', paddingTop: 80 },
  routeBadge: {
  ...
  routeBadgeLoading: { backgroundColor: colors.white, borderWidth: 2, borderColor: colors.black },
  routeBadgeText: { fontSize: 12, fontWeight: '800', letterSpacing: 0.5, color: colors.riderTextMuted },
...
const pickerStyles = StyleSheet.create({
  header: {
    ...
    padding: 16, borderBottomWidth: 1, borderBottomColor: colors.riderBorder,
  },
  ...
  item: {
    ...
    borderBottomWidth: 1, borderBottomColor: colors.riderBorder,
  },
